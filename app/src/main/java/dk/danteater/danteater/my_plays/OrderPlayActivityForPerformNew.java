...
import dk.danteater.danteater.tab_info.BeanOrderPlayReview;
            ...
            public boolean onEditorAction(TextView textView, int i, KeyEvent keyEvent) {
                ...
                if (i == EditorInfo.IME_ACTION_DONE) {
                    ...
                    if (Integer.parseInt(etNumberOfPerformanceValue.getText().toString().trim()) > 4 || Integer.parseInt(etNumberOfPerformanceValue.getText().toString().trim()) < 1) {
                        ((InputMethodManager) getSystemService(INPUT_METHOD_SERVICE)).hideSoftInputFromWindow(etNumberOfPerformanceValue.getWindowToken(), 0);
